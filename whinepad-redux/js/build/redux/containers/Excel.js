...
var Excel = function (_Component) {
  ...
  _createClass(Excel, [{
    ...
    value: function _sort(key) {
      ...
      this.props.dispatch((0, _actions.sort)(key, descending));
      this.setState({
        sortby: key,
    ...
    value: function _save(e) {
      ...
      this.props.dispatch((0, _actions.updateField)(this.state.edit.row, this.state.edit.key, this.refs.input.getWrappedInstance().getValue()));
      this.setState({
        edit: null
      });
    }
    ...
    value: function _deleteConfirmationClick(action) {
      ...
      this.props.dispatch((0, _actions.deleteRecord)(index));
    }
  }, {
    key: '_saveDataDialog',
    value: function _saveDataDialog(action) {
      ...
      var index = this.state.dialog ? this.state.dialog.idx : null;
      (0, _invariant2.default)(typeof index === 'number', 'ステートdialogが不正です');
      this.props.dispatch((0, _actions.updateRecord)(index, this.refs.form.getWrappedInstance().getData()));
    }
  }, {
    key: 'render',
    ...
    value: function _renderDeleteDialog() {
      var index = this.state.dialog ? this.state.dialog.idx : null;
      (0, _invariant2.default)(typeof index === 'number', 'ステートdialogが不正です');
      var first = this.props.data.get(index);
    ...
    value: function _renderTable() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.data.map(function (row, rowidx) {
            return _react2.default.createElement(
              'tr',
              { key: rowidx },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, null, null, { withRef: true })(Excel);